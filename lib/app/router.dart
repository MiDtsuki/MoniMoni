...
class _AuthChangeNotifier extends ChangeNotifier {
  ...
  _AuthChangeNotifier() {
    ...
    guestModeNotifier.addListener(notifyListeners);
  }
}
...
final appRouter = GoRouter(
  ...
  redirect: (context, state) {
    ...
    final isGuest = guestModeNotifier.value;
    final loggedIn = supabaseLoggedIn || isGuest;
    ...
    if (supabaseLoggedIn && isAuthRoute) return '/logs';
    return null;
  },
  routes: [
